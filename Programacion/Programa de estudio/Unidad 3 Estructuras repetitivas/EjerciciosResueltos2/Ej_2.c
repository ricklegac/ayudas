/* 2.Escribir un programa que permita leer 10 números enteros positivos
e imprimir la sumatoria de los números pares y la
sumatoria de los impares.
Se deben validar los datos de entrada. Utilizar el bucle do-while.*/
#include<stdio.h>
int main()
