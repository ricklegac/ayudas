...
//profesora aca use int para el lote y ubicacion para ahorrar tiempo
//pero no tendria problema en castear los strings en integer solo que no me da el tiempo
//tambien podia trabajar unicamente con matrices de tipo string y me ahorraba eso [] [] []
//trabaje asi para mayor legibilidad del codigo.

typedef struct t terr;
int main(){
	printf("----\nlos datos ingresados son en integer por una cuestion de \nlegibilidad con la estructura\n-----\n");
	int tmgi,tmpi,tmli,tmci,tmai,tmfi;
	int r,i,j;
	printf("ingrese R\n");
	scanf("%d",&r);
	terr terreno[r];
